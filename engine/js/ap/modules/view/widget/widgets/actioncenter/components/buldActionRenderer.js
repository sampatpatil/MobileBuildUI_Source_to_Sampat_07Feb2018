                                ...
                                React.DOM.div({
                                    ...
                                    React.DOM.div({
                                        ...
                                        React.DOM.span({
                                            ...
                                            React.DOM.span({
                                                    className: "k-transparent k-button k-button-icon",
                                                    onClick: this.props.remove
                                                },
                                                React.DOM.span({
                                                    className: "k-sprite k-icon EM-Icon EM-Close"
                                                }), " ")
                                        )
                                    ),
                                    ...
                                    React.DOM.div({
                                        ...
                                        React.DOM.span({
                                            className: "icon24 bulkAction"
                                        }, " "),
                                        React.DOM.span(null, this.state.statusStr)
                                    ),
                                    React.DOM.div(null,
                                        React.DOM.div({
                                                className: "progressbar pull-left k-widget k-progressbar k-progressbar-horizontal",
                                                style: progressbarStyle
                                            },
                                            React.DOM.span({
                                                    className: "k-progress-status-wrap"
                                                },
                                                React.DOM.span({
                                                    className: "k-progress-status"
                                                }), " "),
                                            React.DOM.div({
                                                    className: "k-state-selected k-complete",
                                                    style: progressStyle
                                                },
                                                React.DOM.span({
                                                        className: "k-progress-status-wrap",
                                        ...
                                        React.DOM.span({
                                                className: "actionsBtn actions pull-left"
                                            },
                                            React.DOM.span({
                                                ...
                                                React.DOM.span({
                                                    className: "k-sprite k-icon EM-Icon ResumIcon"
                                                }), " "),
                                            React.DOM.span({
                                                ...
                                                React.DOM.span({
                                                    className: "k-sprite k-icon EM-Icon PauseIcon"
                                                }), " ")
                                        )
                                    )
                                )
                    ...
                    types: {
                        ...
                        bulkAction: function(context, item) {
                            ...
                            return bulkAction({
                                ...
                                msg: item,
                                autoStart: start,
                                remove: context.remove.bind(context, item)
                            });
                        },
                        action: 'action',
                        error: 'error'

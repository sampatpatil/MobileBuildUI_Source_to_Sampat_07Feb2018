define(['jquery', 'lib/modules/trafficcop'], function (jQ, trafficcop) { // You might need to set up a config for require.js for the jquery/trafficcop dependencies to work, or replace it with an absolute path
/*
    infuser.js
    Author: Jim Cowart

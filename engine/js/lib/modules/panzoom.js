...
define(['kendo', 'jquery', 'lib/modules/jquery-mousewheel', 'lib/modules/jquery-ui'], function (k, base64, j, ui) {
    /*
    ...
    (function ($, undefined) {
        ...
        $.widget("ui.iviewer", $.ui.mouse, {
            ...
            _create: function () {
                ...
                */
                this.canvas_object = new $.ui.iviewer.CanvasObject(this.options.zoom_animation, this.options.tagSelector);
                ...
                if (this.options.mousewheel) {
                    this.element_object.mouseWheelObject()
                ...
                //init object
                var $clickObj = this.element_object.object();
                //bind mouse events
                (this.options.isCanvas ? $clickObj.siblings() : $clickObj).on('click', function (e) { return me._click(e) });

                if (!this.options.tagSelector)
            ...
            _imageLoaded: function (src) {
                ...
                if (this.options.center) {
                    if (isNaN(this.element_object.display_width()) || isNaN(this.element_object.display_height())) {
                        this.element_object.display_width(this.element_object.orig_width());
                        this.element_object.display_height(this.element_object.orig_height());
                    }
                    this.center();
                }
                if (src)
            ...
            **/
            setCoords: function (x, y) {
                ...
                if (this.element_object._img && !this.element_object.loaded()) { return; }
            ...
            **/
            angle: function (deg, abs) {
                ...
                if (deg < -270 || deg > 270 || deg % 90 !== 0) { return null; }
                if (!abs) { deg += this.img_object.angle(); }
                if (deg < 0) { deg += 360; }
                if (deg >= 360) { deg -= 360; }

                if (deg === this.img_object.angle()) { return null; }
         ...
         * @param {string} tagSelector Tag id of an existing canvas element
         */
        $.ui.iviewer.CanvasObject = function (do_anim, tagSelector) {
            this._canvas = tagSelector ? $(tagSelector) : $("<canvas>");
        ...
        (function () {
            ...
            this.mouseWheelObject = setter(jQuery.noop, function () { return this._getMWObject(); });
        ...
        (function () {
             ...
             * @return {object}
             */
            this._getObject = this._getMWObject = function () {
                return this._img;
            };
        ...
        (function () {
            ...
            * @return {object}
            */
            this._getMWObject = function () {
                return this._canvas.siblings('canvas');
            };

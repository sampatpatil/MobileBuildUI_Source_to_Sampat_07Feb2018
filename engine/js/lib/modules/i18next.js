...
(function (root, factory) {
    ...
    var o = {
        ...
        dataType: 'json', //Added by srinath to override default data type and support other formats
        dataParsers: { // Added by srinath to convert text to data
            'text': function (data) {
                return eval(data);
            }
        }
                ...
                if (typeof options.customLoad == 'function') {
                    ...
                    f.ajax({
                        ...
                        success: function (data, status, xhr) {
                            f.log('loaded: ' + url);
                            var parsed = (-options.dataParsers.hasOwnProperty(options.dataType) && options.dataParsers[options.dataType](data)) || data; // Added by srinath to support custom data parsing
                            loadComplete(null, parsed);
                        },
                        error: function (xhr, status, error) {
                            f.log('failed loading: ' + url);
                            loadComplete('failed loading resource.json error: ' + error);
                        },
                        dataType: options.dataType,//updated by srinath support custom data types
